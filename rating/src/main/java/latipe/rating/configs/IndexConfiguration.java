...
public class IndexConfiguration implements CommandLineRunner {
  ...
  public void run(String... args) {
    ...
    createUniqueIndexIfNotExists(mongoTemplate, "userId");
    createUniqueIndexIfNotExists(mongoTemplate, "storeId");

  }

  private void createUniqueIndexIfNotExists(MongoTemplate mongoTemplate, String fieldName) {
    IndexOperations indexOperations = mongoTemplate.indexOps("Ratings");
