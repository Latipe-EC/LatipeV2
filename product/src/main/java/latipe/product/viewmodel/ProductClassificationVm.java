...
@Builder
public record ProductClassificationVm(String name, int quantity, Double price,
  ...
  public static ProductClassificationVm setCodeName(ProductClassificationVm classification,
    ...
    return new ProductClassificationVm(name, classification.quantity, classification.price,
